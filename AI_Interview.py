...
async def team_config(job_position:str = "Data Scientist"):
    # define model
...
async def interview(team, job_position:str = "Data Scientist"):
    async for message in team.run_stream(task=f"start interview for a {job_position} position"):
